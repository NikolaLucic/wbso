...
- wbso-addon: addon module, custom server and client side code 
- wbso-ui: main application module
- wbso-backend: backend module, contains any server side java code and dependencies
